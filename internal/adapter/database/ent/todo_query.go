...
func (tq *TodoQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (tq *TodoQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(todo.Table, todo.Columns, sqlgraph.NewFieldSpec(todo.FieldID, field.TypeInt64))
	_spec.From = tq.sql
